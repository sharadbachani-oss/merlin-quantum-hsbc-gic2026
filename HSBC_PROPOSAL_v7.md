...
| Graph-shape-only response feature | **withdrawn on its floor** — deterministic in (n, weight multiset); quadratic in cheap scalars gives R² 0.79–0.998 | — | none | 0 (floor cost: minutes) | failed before compute |
